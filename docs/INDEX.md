...
| 我想要 | 先看 | 继续看 |
| --- | --- | --- |
| 快速了解项目能做什么 | [README](README_ZH.md) | [完整配置与部署指南](full-guide.md) |
...
| 文档 | 内容 |
| --- | --- |
| [README](README_ZH.md) | 项目定位、核心能力、快速开始、推送效果 |
...
| [简中 README](README_ZH.md) | 简体中文项目概览与快速开始 |
| [德文 README](../README.md) | Deutschsprachige Projektübersicht und Schnellstart |
